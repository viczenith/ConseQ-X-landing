 ...
 * - open (bool)
 * - onClose (fn)
 * - onUpgrade (fn) optional: should perform upgrade and maybe update auth context
 * - darkMode: optional boolean hint
 * - redirectTo: route after splash (default "/ceo-dashboard")
 */
export default function UpsellModal({
  open,
  onClose = () => {},

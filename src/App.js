        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              >
                Become the most trusted systems-thinking consulting partner in emerging and high-growth markets.
              </motion.p>
              ...
              >
                <div className={`p-6 rounded-xl shadow-md ${
                  ...
                  <p className={darkMode ? "text-gray-300" : "text-gray-600"}>
                    We combine deep industry knowledge with proven systems-thinking methodologies to deliver exceptional results.
                  </p>
                </div>
                ...
                <div className={`p-6 rounded-xl shadow-md ${
                  ...
                  <p className={darkMode ? "text-gray-300" : "text-gray-600"}>
                    Specializing in emerging markets where strategic systems design creates exponential growth opportunities.
                  </p>
                </div>
              </motion.div>
            </motion.div>
              ...
              >
                <div className="flex flex-col md:flex-row gap-8">
                  <div className="flex-1">
                    ...
                    <p className={darkMode ? "text-gray-300" : "text-gray-600"}>
                      Ensuring all parts of your organization are moving in the same strategic direction with shared purpose.
                    </p>
                  </div>
                  <div className="flex-1">
                    <h3 className={`text-xl font-bold mb-4 ${

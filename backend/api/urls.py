...
urlpatterns = [
    ...
    path("visitors/save-progress", views.VisitorSaveProgressView.as_view(), name="visitor_save_progress"),
    path("visitors/save-progress/", views.VisitorSaveProgressView.as_view(), name="visitor_save_progress_slash"),
